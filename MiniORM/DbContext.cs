...
namespace MiniORM
{
    public abstract class DbContext
    {
            ...
            where TEntity: class, new()
        {
            ...
            {
                this.connection.InsertEntities<TEntity>(dbSet.ChangeTracker.Added, tableName, columns);
            }
        ...
        private static bool IsObjectValid(object entity)
        {
            ...
            var result = Validator.TryValidateObject(entity, validationContext, validationErrors, true);
            return result;
        }
